...
public class ShadowTests {
    ...
    public void sphereTriangleInitial() {
        ...
        scene._geometries.add(new Triangle(new Point3D(-70, -40, 0), new Point3D(-40, -70, 0), new Point3D(-68, -68, -4)) //
                        .setEmission(new Color(java.awt.Color.BLUE)) //
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setNshininess(30)) //
        );
        scene.lights.add( //
    ...
    public void trianglesSphere() {
        ...
        scene._geometries.add(new Triangle(new Point3D(-150, -150, -115), new Point3D(-70, 70, -140), new Point3D(75, 75, -150)) //
                        .setMaterial(new Material().setKs(0.8).setNshininess(60))); //
        scene._geometries.add(new Sphere( new Point3D(0, 0, -115),30) //
                        .setEmission(new Color(java.awt.Color.BLUE)) //
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setNshininess(30)) //
        );
        scene.lights.add( //
    ...
    public void sphereTriangleInitial1() {
        scene._geometries.add( //
                new Sphere( new Point3D(0, 0, -200),60) //
                        .setEmission(new Color(java.awt.Color.BLUE)) //
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setNshininess(30))); //
        scene._geometries.add(new Triangle(new Point3D(-62, -32, 0), new Point3D(-32, -62, 0), new Point3D(-58, -58, -4)) //
                .setEmission(new Color(java.awt.Color.BLUE)) //
                .setMaterial(new Material().setKd(0.5).setKs(0.5).setNshininess(30)) //
        );
        scene.lights.add( //
    ...
    public void sphereTriangleInitial2() {
        scene._geometries.add( //
                new Sphere( new Point3D(0, 0, -200),60) //
                        .setEmission(new Color(java.awt.Color.BLUE)) //
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setNshininess(30))); //
        scene._geometries.add(new Triangle(new Point3D(-50, -20, 0), new Point3D(-20, -50, 0), new Point3D(-46, -46, -4)) //
                .setEmission(new Color(java.awt.Color.BLUE)) //
                .setMaterial(new Material().setKd(0.5).setKs(0.5).setNshininess(30)) //
        );
        scene.lights.add( //
