    ...
    public void mytest() {
        ...
        scene.geometries.add(
                ...
                new Sphere(1, new Point3D(-2, 3, 4))
                        .setEmission(new Color(0, 150, 0)).setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(40).setKr(0.5)),
                new Cylinder(0.5,new Ray(new Point3D(-2,3,0),new Vector(0,0,1)), 3)
                        .setEmission(new Color(150, 0, 0)).setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(40))
