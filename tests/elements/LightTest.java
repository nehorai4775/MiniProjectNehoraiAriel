...
class LightsTests {
    ...
    public void trianglesDirectional() {
        ...
        scene2.geometries.add(triangle2.setMaterial(new Material().setKd(0.8).setKs(0.2).setShininess(300)));
    ...
    public void trianglesPoint() {
        ...
        scene2.geometries.add(triangle2.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(300)));
